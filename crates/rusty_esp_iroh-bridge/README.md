...
[![Remade With Rust](https://img.shields.io/badge/Remade%20With-Rust-000?logo=rust&logoColor=fff)](https://github.com/remade-with-rust) [![By Mata Network](https://img.shields.io/badge/by-Mata%20Network-5b2be0)](https://www.mata.network) [![crates.io](https://img.shields.io/crates/v/rusty_esp_iroh-bridge.svg)](https://crates.io/crates/rusty_esp_iroh-bridge) [![docs.rs](https://docs.rs/rusty_esp_iroh-bridge/badge.svg)](https://docs.rs/rusty_esp_iroh-bridge) [![License: MIT OR Apache-2.0](https://img.shields.io/badge/license-MIT%20OR%20Apache--2.0-blue)](https://github.com/Remade-With-Rust/rusty_esp_iroh/blob/main/LICENSE-MIT)

The bridge: one process holding a single peer-to-peer endpoint that fronts many radio neighbours — a bare-metal chip over the peer-to-peer link, a long-range radio node — each with its own authenticated session and its own signed capability manifest.

This is how a chip too small to run TLS still appears on the mesh **as itself**, with its own identity and its own declared capabilities, rather than as a reading inside someone else's device.
