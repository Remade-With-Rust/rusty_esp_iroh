...
[![Remade With Rust](https://img.shields.io/badge/Remade%20With-Rust-000?logo=rust&logoColor=fff)](https://github.com/remade-with-rust) [![By Mata Network](https://img.shields.io/badge/by-Mata%20Network-5b2be0)](https://www.mata.network) [![crates.io](https://img.shields.io/crates/v/rusty_esp_iroh-core.svg)](https://crates.io/crates/rusty_esp_iroh-core) [![docs.rs](https://docs.rs/rusty_esp_iroh-core/badge.svg)](https://docs.rs/rusty_esp_iroh-core) [![License: MIT OR Apache-2.0](https://img.shields.io/badge/license-MIT%20OR%20Apache--2.0-blue)](https://github.com/Remade-With-Rust/rusty_esp_iroh/blob/main/LICENSE-MIT)

The pure half of the mesh package: the protocol labels, the tickets, the binding from a device identity to a network endpoint, the remote-call framing with its signed assertions, the media header, and the JSON contract a home computer already speaks. No sockets, no networking library, no async. `no_std`, `forbid(unsafe)`.

This is the crate that lets a bare-metal chip speak the mesh's language without running a node: the protocols are separable from the transport, and this half is the protocols.
