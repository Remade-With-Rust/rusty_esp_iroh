...
fn main() -> Result<()> {
    ...
    rt.block_on(async move {
        ...
        let config = NodeConfig {
            ...
            // Measured on this part: it served two subscriptions and
            // panicked at four, each costing 17,000-19,088 B of its ~73,000 B
            // of free internal RAM (2026-09-16). A cap refuses the third and
            // counts it; no cap crashes the device.
            max_media_subscribers: 2,
            // Not wired on this firmware: nothing advertised rather than a
            // zero that would read as "never crashed".
            boot: None,
        };
        let extras = Extras {
